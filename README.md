...
このエクササイズは、デーモンワークにおいて二つの利点があります。すでに過ぎ去った出来事に対しても続く、いわゆるデーモン的な反応から自分を解放できること。デーモンに起こりそうな状況を心に投影することで、そのデーモンに特有の思考・感情・行動パターンを見極められるようになり、反応に飲み込まれる前に気づけること。フィードバック・ループの起点を把握できれば、それを断ち切るのは格段に楽になります。
